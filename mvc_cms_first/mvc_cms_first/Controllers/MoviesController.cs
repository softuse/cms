...
namespace mvc_cms_first.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public IActionResult Index(string movieGenre,string searchString)
        {
            ...
            var genreQry = from d in _context.Movies orderby d.Genre select d.Genre;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,ReleaseDate,Genre,Price,Test")] Movie movie)
        {
            if (id != movie.ID)
            {
                return NotFound();
